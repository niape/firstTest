...
<div class="right">
        ...
        <div class="providerAdd">
            <fm:form modelAttribute="user" enctype="multipart/form-data" id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/user/useraddsave.html">
                ...
                <div>
                    ...
                    <input type="file" name="a_idPicPath" id="a_workPicPath"  value=""/>
